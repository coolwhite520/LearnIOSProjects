...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    {   
        ...
        title = [NSString stringWithFormat:@"distance:%ld,direction:%@,location:%@,firstId:%@,firstName:%@",
                                                                                 (long)roadInter.distance,
                                                                                 roadInter.direction,
                                                                                 roadInter.location,
                                                                                 roadInter.firstId,
                                                                                 roadInter.firstName];
...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        ...
        {
            subTitle = [NSString stringWithFormat:@"province:%@,city:%@,district:%@,town:%@,neighborhood:%@,building:%@",
